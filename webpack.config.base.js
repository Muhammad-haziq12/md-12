...
const PRODUCTION_API_BASE_URL = 'https://mdapi12.azurewebsites.net'; // to be changed to point to the URL of your API
...
const PRODUCTION_PATH_PREFIX = 'https://github.com/Muhammad-haziq12/md-12'; // e.g. '/mymovies/' if you deploy to GitHub Pages as a Project site : mymovies would be the repo name
