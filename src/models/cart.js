...
const readcarteFromUsername = async(username)=>{
    try {
        ...
        const response = await fetch(`${process.env.API_BASE_URL}/api/cart/readcarteFromUsername`, options);
    ...
    const addtopanier = async(username, idmenu)=>{
        ...
        try {
            ...
            const response = await fetch(`${process.env.API_BASE_URL}/api/cart/addMenuToPanier`, options);
            const cart = await response.json();
        ...
        const deleteCart = async (username) => {
          ...
          try {
            ...
            const response = await fetch(`${process.env.API_BASE_URL}/api/cart/deletepaniertotal`, options);
