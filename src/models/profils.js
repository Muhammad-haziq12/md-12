...
const userinformation = async(username)=>{
    try {
        ...
        const response = await fetch(`${process.env.API_BASE_URL}/api/auths/username`, options);
  ...
  const getMenuByid  = async(id)=>{
      try{
        const response = await fetch(`${process.env.API_BASE_URL}/api/menus/${id}`);
...
const addOnemenutofavourites = async (username, menuId) => {
  ...
  try {
    ...
    const response = await fetch(`${process.env.API_BASE_URL}/api/auths/addMenuLike`, options);
...
const readAllUsers = async()=>{
  try {
    const response = await fetch(`${process.env.API_BASE_URL}/api/auths`);
...
const deleteOneUser = async (id) => {
  try {
    ...
    const response = await fetch(`${process.env.API_BASE_URL}/api/auths/${id}`, options);
